                           ...
                           <div class="iso-box-wrapper">
                                ...
                                <div class="my-gallery row">
                                    ...
                                    <figure class="iso-box graphic branding col-md-6 col-xs-6">
                                        <!-- <a href="img/skincare/skincare (5).jpg" itemprop="contentUrl" data-size="2978x2086"> -->
                                            <img src="img/skincare/skincare (5).jpg" itemprop="thumbnail" alt="Image description" />
                                        </a>
                                    ...
                                    <figure class="iso-box graphic branding col-md-3 col-xs-6">
                                        <!-- <a href="img/skincare/skincare (2).jpg" itemprop="contentUrl" data-size="2978x2086"> -->
                                            <img src="img/skincare/skincare (2).jpg" itemprop="thumbnail" alt="Image description" />
                                        </a>
                                    <!-- <figcaption itemprop="caption description">Image caption 1</figcaption> -->
                                    ...
                                    <figure class="iso-box graphic branding col-md-3 col-xs-6">
                                        <!-- <a href="img/skincare/skincare (3).jpg" itemprop="contentUrl" data-size="2978x2086"> -->
                                            <img src="img/skincare/skincare (3).jpg" itemprop="thumbnail" alt="Image description" />
                                        </a>
                                    <!-- <figcaption itemprop="caption description">Image caption 1</figcaption> -->
                                    ...
                                    <figure class="iso-box graphic branding col-md-3 col-xs-6">
                                        <!-- <a href="img/skincare/skincare (4).jpg" itemprop="contentUrl" data-size="2978x2086"> -->
                                            <img src="img/skincare/skincare (4).jpg" itemprop="thumbnail" alt="Image description" />
                                        </a>
                                    <!-- <figcaption itemprop="caption description">Image caption 1</figcaption> -->
                                    ...
                                    <figure class="iso-box graphic branding col-md-3 col-xs-6">
                                        <!-- <a href="img/skincare/skincare (1).jpg" itemprop="contentUrl" data-size="2978x2086"> -->
                                            <img src="img/skincare/skincare (1).jpg" itemprop="thumbnail" alt="Image description" />
                                        </a>
                                    <!-- <figcaption itemprop="caption description">Image caption 1</figcaption> -->
