                           ...
                           <div class="iso-box-wrapper">
                                ...
                                <div class="my-gallery row">
                                    ...
                                    <figure class="iso-box graphic branding col-md-6 col-xs-6">
                                        <!-- <a href="img/brow/brow (5).png" itemprop="contentUrl" data-size="2978x2086"> -->
                                            <img src="img/brow/brow (2).jpg" itemprop="thumbnail" alt="Image description" />
                                        </a>
                                    ...
                                    <figure class="iso-box graphic branding col-md-3 col-xs-6">
                                        <!-- <a href="img/brow/brow (2).png" itemprop="contentUrl" data-size="2978x2086"> -->
                                            <img src="img/brow/brow (1).png" itemprop="thumbnail" alt="Image description" />
                                        </a>
                                    <!-- <figcaption itemprop="caption description">Image caption 1</figcaption> -->
                                    ...
                                    <figure class="iso-box graphic branding col-md-3 col-xs-6">
                                        <!-- <a href="img/brow/brow (3).png" itemprop="contentUrl" data-size="2978x2086"> -->
                                            <img src="img/brow/brow (2).png" itemprop="thumbnail" alt="Image description" />
                                        </a>
                                    <!-- <figcaption itemprop="caption description">Image caption 1</figcaption> -->
                                    ...
                                    <figure class="iso-box graphic branding col-md-3 col-xs-6">
                                        <!-- <a href="img/brow/brow (4).png" itemprop="contentUrl" data-size="2978x2086"> -->
                                            <img src="img/brow/brow (3).png" itemprop="thumbnail" alt="Image description" />
                                        </a>
                                    <!-- <figcaption itemprop="caption description">Image caption 1</figcaption> -->
                                    ...
                                    <figure class="iso-box graphic branding col-md-3 col-xs-6">
                                        <!-- <a href="img/brow/brow (1).png" itemprop="contentUrl" data-size="2978x2086"> -->
                                            <img src="img/brow/brow (1).jpg" itemprop="thumbnail" alt="Image description" />
                                        </a>
                                    <!-- <figcaption itemprop="caption description">Image caption 1</figcaption> -->
